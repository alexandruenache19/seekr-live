...
const renderSEOTags = () => {
  ...
  const description =
    "A social centralized place for all the cool things you come across online - Tweets, TikToks, links, videos. Save content from virtually any app or website.";
...
export default function Home({ ...props }) {
  ...
  return (
    <>
      ...
      >
        <NextImage layout="fill" objectFit="cover" src="/main-bg.jpg" />
      </View>
      <div
        style={{
          position: "fixed",
        ...
        className={scrolled ? "header-wrap with-light-bg" : "header-wrap"}
      >
        <Header isOnMobile={isOnMobile} />
      </div>
      <ModalVideo
        channel="youtube"
        autoplay
      ...
      />
      <ScrollView style={{ width: "100%", flex: 1, zIndex: 4 }}>
        <View
          style={{
        ...
        >
          ...
          <Demo
            ...
            setVideoModalOpen={() => setVideoModalOpen(true)}
          />
